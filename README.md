...
Welcome to my collection of MATLAB projects! This repository contains various academic and personal projects developed using MATLAB for signal processing, power electronics, control systems, simulations, numerical methods, and more.
...
| `To formulate YBUS by step-by-step method (Direct Method)` | Computes the Y-bus matrix for power systems using the direct method. |
